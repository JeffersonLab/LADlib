...
TVector3 THcLADHodoscope::GetHitPosition(int plane, int paddle, double ypos=0) {
  ...
  TVector3 hit = TVector3(offset, ypos + fPlanes[plane]->GetPosOffset(), fPlanes[plane]->GetZpos());
